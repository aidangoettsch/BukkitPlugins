...
public class Packet0FSpawnMob extends AbstractPacket {
    public static final int ID = 15;

    private static PacketConstructor entityConstructor;

    public Packet0FSpawnMob() {
        super(new PacketContainer(ID), ID);
        handle.getModifier().writeDefaults();
    }

    public Packet0FSpawnMob(PacketContainer packet) {
        super(packet, ID);
    }

    public Packet0FSpawnMob(Entity entity) {
